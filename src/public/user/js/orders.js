document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".return-order-btn").forEach((button) => {
    button.addEventListener("click", async () => {
      ...
      try {
        const response = await fetch(`/profile/orders/${orderId}/return`, {
          method: "PATCH",
        });
  ...
  document.querySelectorAll(".buy-again-btn").forEach((button) => {
    button.addEventListener("click", () => {
      ...
      window.location.href = `/profile/orders/${orderId}/buy-again`;
    });
  });
  ...
  document.querySelectorAll(".invoice-btn").forEach((button) => {
    button.addEventListener("click", () => {
      ...
      window.location.href = `/profile/orders/${orderId}/invoice`;
    });
  });
