...
router.post("/profile/confirm-email-password", userAuth, confirmEmailPassword);

router.post("/profile/resend-otp", resendProfileOTP);

router.get("/profile/editpassword", userAuth, noCache, loadChangePassword);

router.post("/profile/editpassword", userAuth, changePassword);

router.get("/profile/address", userAuth, noCache, loadAddress);

router.get("/address/add-address", userAuth, noCache, loadAddAddressPage);

router.post("/address/add-address", userAuth, addAddress);
router.get("/address/edit-address/:id", userAuth, noCache, loadEditAddressPage);

router.put("/address/edit-address/:id", userAuth, updateAddress);

router.delete("/address/delete/:id", userAuth, deleteAddress);
...
router.patch("/orders/:orderId/cancel", userAuth, cancelWholeOrder);

router.patch("/orders/:orderId/return", userAuth, returnWholeOrder);

router.get("/profile/orders/:id/invoice", userAuth, downloadInvoice);

router.post("/profile/orders/:id/buy-again", userAuth, buyAgain);

router.get("/profile/orders/:id/summary", userAuth, downloadOrderSummary);
