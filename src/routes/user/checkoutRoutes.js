...
router.get("/address/add-address", userAuth, addressController.loadAddAddressPage);
router.post("/address/add-address", userAuth, addressController.addAddress);

router.get("/address/edit-address/:id", userAuth, addressController.loadEditAddressPage);
